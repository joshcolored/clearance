...
import { Users, CheckCircle, Clock, FileText, Target } from 'lucide-react';
...
const TeamLeaderDashboard = () => {
  ...
  const loadData = () => {
    ...
    if (savedItems) {
      ...
      const teamLeaderItems = items.filter(item => item.department === 'team_leader');
      setClearanceItems(teamLeaderItems);
    }
    ...
    const updatedItems = clearanceItems.map(item =>
      item.id === selectedTask.id
        ? {
            ...
            completedBy: user?.name || 'Team Leader',
  ...
  const handoverData = clearanceItems.reduce((acc: any[], item) => {
  ...
  return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardContent className="p-6">
              <CustomPieChart data={statusData} title="Handover Status Distribution" />
            </CardContent>
          </Card>
          
          <Card>
            <CardContent className="p-6">
              <CustomBarChart data={handoverData} title="Team Member Handover Progress" />
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Project Handover Tasks</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Complete Handover Task</DialogTitle>
              <DialogDescription>
                Mark this handover task as completed and add your signature
              </DialogDescription>
            </DialogHeader>
            {selectedTask && (
